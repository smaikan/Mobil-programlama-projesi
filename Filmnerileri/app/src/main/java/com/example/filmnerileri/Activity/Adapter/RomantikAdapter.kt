...
class RomantikAdapter : RecyclerView.Adapter<RomantikAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<RomantikModel>()
    private var selectedfilms = ArrayList<RomantikModel>()
    ...
    fun setData(data: ArrayList<RomantikModel>) {
        arrayData = data
    ...
    override fun onBindViewHolder(holder: RecipeViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, Korku::class.java)
