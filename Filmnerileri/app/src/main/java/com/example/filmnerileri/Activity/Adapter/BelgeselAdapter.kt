...
class BelgeselAdapter : RecyclerView.Adapter<BelgeselAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<BelgeselModel>()
    private var selectedfilms = ArrayList<BelgeselModel>()
    ...
    fun setData(data: ArrayList<BelgeselModel>) {
        arrayData = data
