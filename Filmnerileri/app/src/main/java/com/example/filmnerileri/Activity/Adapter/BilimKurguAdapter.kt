...
class BilimKurguAdapter : RecyclerView.Adapter<BilimKurguAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<BilimKurguModel>()
    private var selectedfilms = ArrayList<BilimKurguModel>()
    ...
    fun setData(data: ArrayList<BilimKurguModel>) {
        arrayData = data
