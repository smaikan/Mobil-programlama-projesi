...
class MaceraAdapter : RecyclerView.Adapter<MaceraAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<MaceraModel>()
    private var selectedfilms = ArrayList<MaceraModel>()
    ...
    fun setData(data: ArrayList<MaceraModel>) {
        arrayData = data
