...
class AksiyonAdapter : RecyclerView.Adapter<AksiyonAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<AksiyonModel>()
    private var selectedfilms = ArrayList<AksiyonModel>()
    ...
    fun setData(data: ArrayList<AksiyonModel>) {
        arrayData = data
