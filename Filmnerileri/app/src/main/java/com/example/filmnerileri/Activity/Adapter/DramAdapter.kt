...
class DramAdapter : RecyclerView.Adapter<DramAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<DramModel>()
    private var selectedfilms = ArrayList<DramModel>()
    ...
    fun setData(data: ArrayList<DramModel>) {
        arrayData = data
