...
class KomediAdapter : RecyclerView.Adapter<KomediAdapter.RecipeViewHolder>() {
    private var arrayData = ArrayList<KomediModel>()
    private var selectedfilms = ArrayList<KomediModel>()
    ...
    fun setData(data: ArrayList<KomediModel>) {
        arrayData = data
